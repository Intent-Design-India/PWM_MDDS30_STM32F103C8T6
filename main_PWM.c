...
char Screen_1[] = {"Button_1"};
char Screen_2[] = {"Button_2"};
char Screen_3[] = {"Button_3"};
char Screen_4[] = {"No_Input"};
...
int main(void)
{
  ...
  while (1)
  {
	      ...
	      {
	    	  Show_Page(Screen_2);
	    	  //gpioResult = GPIO_PIN_2;
	      }
	      else if (Button_3 == GPIO_PIN_SET)
	      {
	    	  Show_Page(Screen_3);
	    	  //gpioResult = GPIO_PIN_3;
	      }
	      else
	      {
	    	  Show_Page(Screen_4);
...
void Show_Page(char set[])
{
	SSD1306_GotoXY (0, 0);
	//SSD1306_InvertDisplay(1);
	SSD1306_Puts( set, &Font_11x18, 0);
